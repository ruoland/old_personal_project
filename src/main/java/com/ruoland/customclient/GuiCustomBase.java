...
import com.ruoland.customclient.component.GuiCusTextField;
import com.ruoland.customclient.component.GuiTexture;
import com.ruoland.customclient.component.IGuiComponent;
...
public class GuiCustomBase extends GuiScreen {
    ...
    public void initGui() {
        ...
        System.out.println(guiData.backgroundImage+"11111");
    ...
    public void setDynamicTextureField(ResourceLocation resourceLocation, String textureField) {
        ...
        if (isSelectTexture()) {
           getSelTexture().resourceLocation = resourceLocation;
