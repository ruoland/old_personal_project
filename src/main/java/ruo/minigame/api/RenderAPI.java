...
public class RenderAPI {
	...
	public static void drawTexture(String texture,  double x, double y, double width, double height) {
			drawTexture(texture, 1,1,1, 1, x, y, width, height, true);
	}
	public static void drawTexture(String texture, float alpha, double x, double y, double width, double height) {
		drawTexture(texture, 1,1,1, alpha, x, y, width, height, true);
	}
	...
	public static void drawTexture(ResourceLocation texture, float alpha, double x, double y, double width,
								   double height) {
		drawTexture(texture.toString(), 1,1,1, alpha, x, y, width, height, true);
	}
	public static void drawTexture(String texture, float red, float green, float blue, float alpha, double x, double y, double width, double height,
								   boolean push) {
