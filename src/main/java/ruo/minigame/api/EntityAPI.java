...
public class EntityAPI {
	...
	public static double forwardLeftX(EntityLivingBase base, double plus, boolean pos) {
		EnumFacing left = EnumFacing.fromAngle(base.getHorizontalFacing().getHorizontalAngle() - 90);
		return forwardX(base, left, plus, pos);
	}
	public static double forwardLeftZ(EntityLivingBase base,double plus, boolean pos) {
		EnumFacing left = EnumFacing.fromAngle(base.getHorizontalFacing().getHorizontalAngle() - 90);
		return forwardZ(base,left, plus, pos);

	}
	public static double forwardRightX(EntityLivingBase base,double plus, boolean pos) {
		EnumFacing right = EnumFacing.fromAngle(base.getHorizontalFacing().getHorizontalAngle() + 90);
		return forwardX(base,right, plus, pos);
	}
	public static double forwardRightZ(EntityLivingBase base,double plus, boolean pos) {
		EnumFacing right = EnumFacing.fromAngle(base.getHorizontalFacing().getHorizontalAngle() + 90);
