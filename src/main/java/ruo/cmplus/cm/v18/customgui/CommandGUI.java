...
import ruo.cmplus.cm.v18.customgui.GuiCustom.GuiCusButton;
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if (args.length == 1)
			...
			if (t.argCheck(args[0], "button", "버튼")) {
				...
				GuiCusButton b = new GuiCusButton(Integer.valueOf(args[1]), (int) VAR.getDouble(args[2]),  (int) VAR.getDouble(args[3]), args[1]);
