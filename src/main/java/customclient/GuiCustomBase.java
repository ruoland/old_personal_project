...
import customclient.button.ButtonFunction;
import customclient.component.*;
    ...
    public void setEditMode() {
        ...
        if (!editMode) {
            for (GuiButton button : buttonList) {
                ...
                System.out.println("[에디트 모드]비활성화 되어 리로드함--------------");
                cusButton.buttonBucket.reload();
                System.out.println("[에디트 모드]리로드 끝남---------------");
            }
        }
