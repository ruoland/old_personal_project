...
import map.tycoon.block.BlockBreadCall;
import map.tycoon.block.BlockBreadDisplay;
import map.tycoon.block.bread.BlockBreadWorkbench;
import map.tycoon.block.bread.ItemFlour;
import map.tycoon.block.bread.ItemFrame;
import map.tycoon.block.shopping.BlockShopping;
...
public class TyconMain {
	...
	@SidedProxy(serverSide = "map.tycoon.CommonProxy", clientSide = "map.tycoon.ClientProxy")
