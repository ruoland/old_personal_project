package rmap.lot.dungeon.arrow;
...
public class EntityDunArrow extends EntityDefaultNPC implements IProjectile{
	public boolean isAAA;
	public EntityDunArrow(World worldIn) {
		super(worldIn);
		this.setSize(1, 2);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public EntityDunArrow(World worldIn, double x, double y, double z)
    {
        this(worldIn);
        this.setPosition(x, y, z);
    }

    public EntityDunArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                if (!this.worldObj.isRemote && this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ < 0.0010000000474974513D)
                {
                    ...
                    {
                        this.entityDropItem(new ItemStack(Items.ARROW), 0.1F);
                    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.pickupStatus == EntityArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(new ItemStack(Items.ARROW)))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityDunArrow.PickupStatus getByOrdinal(int ordinal)
        {
