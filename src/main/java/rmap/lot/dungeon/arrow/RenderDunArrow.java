...
public class RenderDunArrow<T extends EntityDunArrow> extends Render<T>
{
    ...
    public RenderDunArrow(RenderManager renderManagerIn)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityDunArrow entity)
    {
        return RES_ARROW;
    }
}