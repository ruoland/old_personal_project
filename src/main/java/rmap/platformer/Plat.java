...
import rmap.platformer.chapter1.EntityBabyCow;
import rmap.platformer.chapter1.EntityBossHorse;
import rmap.platformer.chapter1.EntityCowBumo;
import rmap.platformer.chapter1.EntityPlatBlock;
...
public class Plat {
    ...
    @SidedProxy(serverSide = "ruo.map.platformer.CommonProxy", clientSide = "ruo.map.platformer.ClientProxy")
